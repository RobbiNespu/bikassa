...
public class DemoWarehouseModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bindListener(new SubclassesOf(PcxStationImpl.class), new EventBusRegistrationListener(incomingEventBus));
    bindListener(new SubclassesOf(PcxConnection.class), new EventBusRegistrationListener(outgoingEventBus));
  }
