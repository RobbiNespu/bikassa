...
public class DemoWarehousePcxConnectionsModule2 extends AbstractModule {
  ...
  protected void configure() {
    ...
    MapBinder<String, Service2> mapBinder = MapBinder.newMapBinder(binder(), String.class, Service2.class);
