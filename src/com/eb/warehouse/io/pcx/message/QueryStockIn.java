...
public class QueryStockIn
   ...
   * there is not a <CODE>set</CODE> method for the boxes property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link QueryBox }
   */
   ...
   *
   * @return possible object is {@link QueryState }
   */
   ...
   *
   * @param value allowed object is {@link QueryState }
   */
