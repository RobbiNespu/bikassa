 ...
 * @version $Revision: 1662 $, $Date: 2014-02-10 08:56:54 +0100 (Mo, 10 Feb 2014) $, $Author: dennis.chong $
 */
...
public class NGKPTelegram implements Telegram, Serializable {
  ...
  /**
   * Converts the fields of the telegram into a string. Overridden in the different telegram sub types.
   * 
   * @return the to-string-representation of the fields of the telegram
   */
  public String fieldsToString() {
    return "senderId=" + senderID + "," + " receiverId=" + receiverID + "," + " telegramType=" + telegramType + "," + " subType=" + subType + "," + " version=" + version + "," + " requestID=" + requestID + "," + " producerID=" + producerID + ",";
  }
  ...
  /**
   * Helper method to insert an long to end of a given hex value.
   * Negatives are now allowed.
   * 
   * @param hex the hex value to complete
  ...
  /**
   * Formats the given string to have the given length. If needed, the string is filled with blanks.
   * 
