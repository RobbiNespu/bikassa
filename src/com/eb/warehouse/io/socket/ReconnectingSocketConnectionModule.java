...
public class ReconnectingSocketConnectionModule extends AbstractModule {

  private final int port;

  public ReconnectingSocketConnectionModule(int port) {
    this.port = port;
  }
  ...
  protected void configure() {
    configureBinding(SocketConnection.class, PermanentSocketConnection.class);
    ...
    bind(ThreadFactory.class).annotatedWith(Names.named("connectAndReadSocketThreadFactory")).to(
  ...
  @Provides
  ListeningExecutorService createConnectAndReadRunner(
      @Named("connectAndReadSocketThreadFactory") ThreadFactory threadFactory) {
