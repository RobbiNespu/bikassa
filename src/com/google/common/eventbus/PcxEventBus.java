...
import com.google.common.eventbus.EventBus.EventWithSubscriber;
...
public class PcxEventBus extends EventBus {

  public static interface PcxEventReceiver {
   ...
   */
  public PcxEventBus(String identifier) {
   ...
   * @since 16.0
   */
  public PcxEventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
